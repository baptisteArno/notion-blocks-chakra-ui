        ...
        case 'paragraph':
            ...
            if (richTexts[0].text.content.startsWith('[video')) {
                var videoProps = richTexts[0].text.content
                    ...
                    .map(function (val) { return val.trim(); })
                    .slice(1);
                return (react_1.default.createElement("video", { width: "100%", height: (_b = videoProps[1]) !== null && _b !== void 0 ? _b : '300px', style: { maxHeight: (_c = videoProps[1]) !== null && _c !== void 0 ? _c : '300px' }, controls: true },
