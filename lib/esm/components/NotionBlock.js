    ...
    switch (type) {
        case 'paragraph':
            ...
            if (richTexts[0].text.content.startsWith('[image')) {
                ...
                return (React.createElement(Box, { w: "100%", h: (_b = imageProps[1]) !== null && _b !== void 0 ? _b : '300px', pos: "relative" }, customImage && customImage.Image ? (React.createElement(customImage.Image, __assign({ src: imageProps[0] }, customImage.props))) : (React.createElement(Image, { src: imageProps[0], layout: "fill", objectFit: "contain" }))));
            }
            if (richTexts[0].text.content.startsWith('[video')) {
                var videoProps = richTexts[0].text.content
                    ...
                    .map(function (val) { return val.trim(); })
                    .slice(1);
                return (React.createElement("video", { width: "100%", height: (_c = videoProps[1]) !== null && _c !== void 0 ? _c : '300px', style: { maxHeight: (_d = videoProps[1]) !== null && _d !== void 0 ? _d : '300px' }, controls: true },
